...
Follow the relevant [Hugo installation
instructions](https://gohugo.io/installation/) for your situation.

The `netlify.toml` file defines the Hugo version used by Netlify, and the end
of `config.toml` specifies the min/max compatible Hugo versions for the current
site config.
...
And head to <http://localhost:1313> to view the result. Which should look
